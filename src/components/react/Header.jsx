...
export const Header = () => {
  ...
  return (
    <header class="py-4 md:px-8 px-2 flex justify-between items-center w-full fixed top-0 xl:static bg-meros-green/70 backdrop-blur z-[99999]">
      <div class="md:hidden group" onClick={() => setIsActive(!isActive)}>
        <Bars />
      </div>
      <figure class="w-[198px] h-[63px] md:block hidden">
        <img
          src="/logo_meros.png"
          alt="los meros meros logo"
          class="w-full h-full"
        />
      </figure>
      <figure class="md:hidden w-[50px]">
        <img
          src="/meros_icon.png"
          alt="los meros meros logo"
          class="w-full h-full"
      ...
      <div class="md:hidden flex justify-center items-center hover:bg-meros-red/50 border border-transparent hover:border-meros-red overflow-hidden transition-all p-2 rounded">
        <a
          href="/CARTA MEROS MEROS.pdf"
      ...
      <nav class={`fixed left-0 md:static top-[95px] ${isActive ? "translate-x-0" : "-translate-x-full"} transition-all`}>
        <ul class="flex gap-[22px] [&>li]:font-Hitchcut [&>li]:text-lg [&>li]:cursor-pointer text-white md:flex-row flex-col bg-meros-green h-screen md:h-auto w-[250px]">
          <li class="group flex justify-center items-center flex-col">
            <a href="#nosotros">
              <span>Nosotros</span>
            </a>
            <div class="bg-meros-red w-0 h-[2px] mt-[2px] group-hover:w-full transition-all"></div>
          </li>
          <li class="group flex justify-center items-center flex-col">
            <a href="#paquetes">
              <span>Paquetes</span>
          ...
          <li class="group flex justify-center items-center flex-col">
            <a
              href="https://wa.me/51964189692?text=Quiero%20saber%20más%20sobre%20la%20covertura%20del%20delivery"
              target="_blank"
            >
              <span>Delivery</span>
            </a>
